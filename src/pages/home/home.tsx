...
export default class Ucbody extends Component<{},{}>{
	...
	componentWillMount () {
		let $this=this;
		// 个人待审批
        // let url = '/bizrest/bcbizcertifcationuser/?query={"$and":[{"status":{"$in":[1,2]}}]}';
        // fetch(url,{
        //     method:'GET',
        //     credentials:'include',
        //     mode:'no-cors',
        ...
        // 个人已审批
        // let query='{"$and":[{"status":{"$in":[3,4]}}]}';
		let url1 = 'http://192.168.10.208:8001/fbs/bizrest/bcbizcertifcationuser/';
        axios.get(url1, {
            params: {
		...
		// // 企业待审批
		let url2 = '/bizrest/bcbizcertifcationorganize/?query={"$and":[{"status":{"$in":[1,2]}}]}';
        fetch(url2,{
            method:'GET',
            credentials:'include',
            mode:'no-cors',
		...
		// 企业已审批
		let url3 = '/bizrest/bcbizcertifcationorganize/?query={"$and":[{"status":{"$in":[3,4]}}]}';
        fetch(url3,{
            method:'GET',
            credentials:'include',
            mode:'no-cors',
